    ...
    return (
        <main>
            <span className="flex-centre-row">
                ...
                {breakpoint >= 450 && <button id='settings-btn' onClick={() => setIsSettingsModalOpen(true)} title='Open settings'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
            ...
            {breakpoint < 450 && <MobileBar setIsHowToModalOpen={setIsHowToModalOpen} setIsSettingsModalOpen={setIsSettingsModalOpen} />}
        </main>
    )
}