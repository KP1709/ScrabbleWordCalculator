...
const MobileBar = ({ setModalVisibility, isStoreSearchHistory }: MobileBarProps) => {
    return (
        <span className="flex-centre-row mobile-bar">
            <button className=' flex-centre-row bar-button multiplier__button'
            ...
            <button className='flex-centre-row bar-button multiplier__button'
                onClick={() => setModalVisibility((modal) => ({ ...modal, settings: true }))}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" aria-hidden='true'>
            ...
            {isStoreSearchHistory && <button className='flex-centre-row bar-button multiplier__button'
                onClick={() => setModalVisibility((modal) => ({ ...modal, history: true }))}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" aria-hidden='true'>
